...
import  {ERC404_Ownable} from "./ERC404_Ownable.sol";
import {ERC721Receiver} from  "./ERC721Receiver.sol";

/**
 * @title ERC404 Contract
 * @dev A gas-efficient, mixed ERC20 / ERC721 implementation with native liquidity and fractionalization. This is an experimental standard designed to integrate with pre-existing ERC20 / ERC721 support as smoothly as possible. In order to support full functionality of ERC20 and ERC721, supply assumptions are made that slightly constrain usage. Ensure decimals are sufficiently large (standard 18 recommended) as IDs are effectively encoded in the lowest range of amounts. NFTs are spent on ERC20 functions in a FILO queue, this is by design.
 * @author moayaan.eth
 */
abstract contract ERC404 is ERC404_Ownable {
    event ERC20Transfer(
    ...
    function approve(
        ...
        if (amountOrId <= minted && amountOrId > 0) {
            ...
            if (msg.sender != owner && !isApprovedForAll[owner][msg.sender]) {
                revert ERC404_Ownable__Unauthorized();
            }
